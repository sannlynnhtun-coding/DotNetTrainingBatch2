...
using static DotNetTrainingBatch2.MvcApp.Models.StackedAreaChartModel;

using static DotNetTrainingBatch2.MvcApp.Models.StackedBarChart;
	...
	public class CanvasJsController : Controller
	{
		...
		public IActionResult StackedAreaCharts()
		{
			var model = new StackedAreaChartModel()
			{
				...
				IOSDataPoints = new List<StackedAreaChartModel.DataPoints>
					{
						new StackedAreaChartModel.DataPoints { x = 1, y = 3000 },
						new StackedAreaChartModel.DataPoints { x = 2, y = 7000 },
						new StackedAreaChartModel.DataPoints { x = 3, y = 10000 },
						new StackedAreaChartModel.DataPoints { x = 4, y = 14000 },
						new StackedAreaChartModel.DataPoints { x = 5, y = 23000 },
						new StackedAreaChartModel.DataPoints { x = 6, y = 31000 },
						new StackedAreaChartModel.DataPoints { x = 7, y = 42000 },
						new StackedAreaChartModel.DataPoints { x = 8, y = 56000 },
						new StackedAreaChartModel.DataPoints { x = 9, y = 64000 },
						new StackedAreaChartModel.DataPoints { x = 10, y = 81000 },
						new StackedAreaChartModel.DataPoints { x = 11, y = 105000 }
					},
				AndroidDataPoint = new List<StackedAreaChartModel.DataPoints>
					{
					new StackedAreaChartModel.DataPoints { x = 4, y = 4000 },
					new StackedAreaChartModel.DataPoints { x = 5, y = 6000 },
					new StackedAreaChartModel.DataPoints { x = 6, y = 9000 },
					new StackedAreaChartModel.DataPoints { x = 7, y = 14000 },
					new StackedAreaChartModel.DataPoints { x = 8, y = 21000 },
					new StackedAreaChartModel.DataPoints { x = 9, y = 31000 },
					new StackedAreaChartModel.DataPoints { x = 10, y = 46000 },
					new StackedAreaChartModel.DataPoints { x = 11, y = 61000 }
					}
			};
        ...
        {
            var data = new KKChartsModel.KKPyramidModel()
            {
                Title = "OKNRSR",
                DataPoints = new List<KKChartsModel.KKDataPointsModel>()
                {
                    new KKChartsModel.KKDataPointsModel()
                    {
                        y=26.66,
                        label="Sleep"
                    },new KKChartsModel.KKDataPointsModel()
        ...
        {
            var data = new KKChartsModel.KKRangeAreaModel()
            {
                Title = "Temperature in Toronto - Jan 2024",
                TitleY = "Temperature (°C)",
                SuffixY = "°C",
                TitleX = "",
                DataPoints = new List<KKChartsModel.KKRangeAreaDataPoint>() {
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 01), y = new List<int>() { 15, 21 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 02), y = new List<int>() { 13, 27 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 03), y = new List<int>() { 14, 23 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 04), y = new List<int>() { 17, 25 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 05), y = new List<int>() { 16, 23 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 06), y = new List<int>() { 16, 29 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 07), y = new List<int>() { 18, 27 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 08), y = new List<int>() { 16, 25 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 09), y = new List<int>() { 15, 25 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 10), y = new List<int>() { 16, 23 } },
                    new KKChartsModel.KKRangeAreaDataPoint() { x = new DateTime(2024, 01, 11), y = new List<int>() { 15, 26 } }
                }
		...
		public IActionResult StackedBarChart()
		{
			var model = new StackedBarChart
			{
				...
				Months = new List<StackedBarChart.MonthData>
			{
                new StackedBarChart.MonthData
                {
                    Name = "April",
                    StackedDataPoints = new List<StackedBarChart.StackedDataPoint>
                    {
                        new StackedBarChart.StackedDataPoint { Y = 600, Label = "Water Filter" },
                        new StackedBarChart.StackedDataPoint { Y = 400, Label = "Modern Chair" },
                        new StackedBarChart.StackedDataPoint { Y = 120, Label = "VOIP Phone" },
                        new StackedBarChart.StackedDataPoint { Y = 250, Label = "Microwave" },
                        new StackedBarChart.StackedDataPoint { Y = 120, Label = "Water Filter" },
                        new StackedBarChart.StackedDataPoint { Y = 374, Label = "Expresso Machine" },
                        new StackedBarChart.StackedDataPoint { Y = 350, Label = "Lobby Chair" }
                    }
                },
                new StackedBarChart.MonthData
                {
                    ...
                    StackedDataPoints = new List<StackedBarChart.StackedDataPoint>
                    {
                        new StackedBarChart.StackedDataPoint { Y = 400, Label = "Water Filter" },
                        new StackedBarChart.StackedDataPoint { Y = 500, Label = "Modern Chair" },
                        new StackedBarChart.StackedDataPoint { Y = 220, Label = "VOIP Phone" },
                        new StackedBarChart.StackedDataPoint { Y = 350, Label = "Microwave" },
                        new StackedBarChart.StackedDataPoint { Y = 220, Label = "Water Filter" },
                        new StackedBarChart.StackedDataPoint { Y = 474, Label = "Expresso Machine" },
                        new StackedBarChart.StackedDataPoint { Y = 450, Label = "Lobby Chair" }
                    }
                },
                new StackedBarChart.MonthData
                {
                    ...
                    StackedDataPoints = new List<StackedBarChart.StackedDataPoint>
                    {
                        new StackedBarChart.StackedDataPoint { Y = 300, Label = "Water Filter" },
                        new StackedBarChart.StackedDataPoint { Y = 610, Label = "Modern Chair" },
                        new StackedBarChart.StackedDataPoint { Y = 215, Label = "VOIP Phone" },
                        new StackedBarChart.StackedDataPoint { Y = 221, Label = "Microwave" },
                        new StackedBarChart.StackedDataPoint { Y = 75, Label = "Water Filter" },
                        new StackedBarChart.StackedDataPoint { Y = 310, Label = "Expresso Machine" },
                        new StackedBarChart.StackedDataPoint { Y = 340, Label = "Lobby Chair" }
                    }
                }
            }
            };
