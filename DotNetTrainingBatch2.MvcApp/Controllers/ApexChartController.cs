...
namespace DotNetTrainingBatch2.MvcApp.Controllers
{
    public class ApexChartController : Controller
    {
        ...
        {
            KKChartsModel.KKRadarSeriseModel serie1 = new KKChartsModel.KKRadarSeriseModel()
            {
                name = "Player 1",
                data = new List<int> { 3, 0, 2, 5, 4 }
            };

            var data = new KKChartsModel.KKRadarChartModel()
            {
                Series = new List<KKChartsModel.KKRadarSeriseModel>()
                {
                    serie1
                },
